...
// 1. Make sure that the HTML document is fully loaded before running any jQuery code that is needed below. Make sure you don't
// comment out this code as you'll wrap this code around all the following methods (so don't forget the closing tags, too.
...
/* $(document).ready(function () {
  ...
  $("a").hover(function () {
    $("a").text("Hovering over a paragraph")
  });
});  */
...
/*$(document).ready(function () {
  ...
  $("p").mousemove(function () {
    counter++;
    $("p").text("moved over button " + counter);
  });
});   */
